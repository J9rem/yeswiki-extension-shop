...
class GestionShopHandler extends YesWikiHandler
{
    // private const PATHS = [
    //     'lists' => [
    //         'ListeMois' => 'tools/benevolat/setup/lists/ListeMois.json',
    //         'ListeAnnees' => 'tools/benevolat/setup/lists/ListeAnnees.json',
    //     ],
    //     'forms' => [
    //         'Benevolat' => 'tools/benevolat/setup/forms/Form - Benevolat.txt',
    //         'Benevole' => 'tools/benevolat/setup/forms/Form - Benevole.txt'
    //     ],
    //     'pages' => [
    //         'CreationProfilBenevole' => 'tools/benevolat/setup/pages/CreationProfilBenevole.txt',
    //         'AjoutBenevolat' => 'tools/benevolat/setup/pages/AjoutBenevolat.txt',
    //         'SuiviBenevolat' => 'tools/benevolat/setup/pages/SuiviBenevolat.txt',
    //     ],
    //     'PageRapideHaut' => 'tools/benevolat/setup/pages/PageRapideHautUpdate.txt',
    // ];
    ...
    public function run()
    {
        ...
        //         'new' => $this->params->get('benevolat')['lists'][$listName.'_id'] ?? $listName
        //     ];
        // }
        // $this->formsIds = [];
        // foreach (self::PATHS['forms'] as $formName => $filePath) {
        //     $this->formsIds[$formName] = $this->params->get('benevolat')['forms'][$formName.'_id'] ?? null;
        // }
        // $this->pagesTags = [];
